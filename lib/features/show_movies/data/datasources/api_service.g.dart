...
class _ApiService implements ApiService {
  ...
  Future<MoviesModel> getMoviesByCategory({
    ...
    final _options = _setStreamType<MoviesModel>(
  ...
  Future<MovieCastModel> getMovieCast({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieCastModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<MovieReviewsModel> getMovieReviews({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieReviewsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MovieReviewsModel _value;
    try {
      _value = MovieReviewsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
